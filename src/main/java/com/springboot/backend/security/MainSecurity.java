...
import com.springboot.backend.security.jwt.JwtEntryPoint;
import com.springboot.backend.security.jwt.JwtTokenFilter;
...
public class MainSecurity extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable().authorizeRequests()
				...
				.authenticationEntryPoint(this.jwtEntryPoint).and().sessionManagement()
